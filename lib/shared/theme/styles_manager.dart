...
TextStyle getBoldGreyD012Style() {
  return _getTextStyle(
    12.sp,
    FontWeight.w600,
    greyMedium,
...
TextStyle getVBoldWhite14Style() {
  return _getTextStyle(
    14.sp,
    FontWeight.bold,
    Colors.white,
...
TextStyle getVBoldWhite12Style() {
  return _getTextStyle(
    12.sp,
    FontWeight.bold,
    Colors.white,
...
TextStyle getBoldPrimary10Style() {
  return _getTextStyle(
    10.sp,
    FontWeight.bold,
    primary,
